...
from app.routers import factor_screening as factor_screening_router
from app.routers import portfolio_backtest as portfolio_backtest_router
...
app.include_router(factor_screening_router.router, tags=["factor-screen"])
app.include_router(portfolio_backtest_router.router, tags=["portfolio-backtest"])
